            ...
            <div class="search">
                <form action="" method="POST">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Masukan NIS/NIP/Password" name="nis" autofocus autocomplete="off">
            ...
            <div class="table1 mx-auto mt-5" style="width: 70%;">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php if ($siswa['kelas'] == 'Guru') : ?>
                            <tr>
                                <th scope="row" width="100">Status</th>
                                <td>: <?= $siswa['kelas']; ?></td>
                            </tr>
                            <?php: else if ($siswa['kelas'] == 'Tamu') : ?>
                            <tr>
                                <th scope="row" width="100">Status</th>
                                <td>: <?= $siswa['kelas']; ?></td>
                            </tr>
