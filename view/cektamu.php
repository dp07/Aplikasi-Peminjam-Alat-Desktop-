...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="search">
                <div>
                    <a href="registrasitamu.php?status=no" class="btn btn-primary mb-3 float-right">Belum Registrasi?</a>
                </div>
                <form action="" method="POST">
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" placeholder="Masukan Password" name="nis" autofocus autocomplete="off">
